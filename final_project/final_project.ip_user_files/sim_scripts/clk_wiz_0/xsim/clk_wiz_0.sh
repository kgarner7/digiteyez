...
#
# Generated by Vivado on Mon Nov 04 20:13:36 -0500 2019
...
xv_boost_lib_path=D:/_random_software/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="D:/_random_software/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
